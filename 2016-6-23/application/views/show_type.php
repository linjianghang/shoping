...
<head>
    <meta charset="UTF-8">
    <title><?php foreach($list as $val){} echo $val['subclass'];?>专区</title>
...
<div id="title"><?php echo @$val['subclass'];?>专区</div>
<div id="subclass"><?php echo @$val['commodity_classification'];?>><?php echo @$val['subclass'];?></div>
